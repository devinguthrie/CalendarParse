...
namespace CalendarParse.Services
{
    ...
    /// <summary>Runs on-device OCR and returns text with bounding rectangles.</summary>
    public interface IOcrService
    {
        /// <summary>
        /// Runs ML Kit Text Recognition on <paramref name="imageBytes"/> (original, unprocessed PNG/JPEG).
